...
package GUILayer;
	...
	import TableModelLayer.PayrollTableModelLayer;

	public class PayrollManagerFrame extends JFrame{
		...
		public PayrollManagerFrame(JFrame parent) {
		...
		private void showDetailFrame(int id) {
			...
			PayrollDetailFrame pf = new PayrollDetailFrame(id, this);
			pf.setVisible(true);
			setVisible(false);
		}
		...
		private void addUpperComponent() {
			...
			btnEdit.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int id = (int)tblPayroll.getValueAt(row, 0);
					showDetailFrame(id);			
				}
			});
			...
			btnDelete.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (x==0) {
						...
						boolean r = payrollDao.Delete(id);
				        if(r) {
		...
		private void addLowerComponent() {
			...
			tblPayroll = new JTable();
			tblPayroll.setBackground(Color.WHITE);
			
			JScrollPane sp = new JScrollPane();
			sp.setBounds(10, 15, 565, 340);
			this.lowerPanel.add(sp);
			sp.setViewportView(tblPayroll);
		...
		protected void populateTable() {
			...
			ArrayList<Payroll> userList = payrollDao.getAll(txtSearch.getText());
			
			   PayrollTableModelLayer model = new PayrollTableModelLayer(userList);
