...
package GUILayer;
	...
	public class IndividualPayslipManagerFrame extends JFrame{
		...
		public IndividualPayslipManagerFrame(JFrame parent) {
		...
		private void showDetailFrame(int id) {
			...
			IndividualPayslipDetailFrame in = new IndividualPayslipDetailFrame(this, id);
			in.setVisible(true);
			setVisible(false);
		}
		...
		protected void populateTable() {
			...
			ArrayList<Payslip> userList = payslipDao.getAllByEmployee_ID(txtSearch.getText());
